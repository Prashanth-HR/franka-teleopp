...
#include <tele_operation/Jacobian.h>
...
class TeleopJointPDExampleController : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  struct FrankaDataContainer {
    ...
    std::unique_ptr<franka_example_controllers::JointWallContainer<7>> virtual_joint_wall;
  ...
  realtime_tools::RealtimePublisher<tele_operation::Jacobian> follower_jacob_pub_;
